...
public class RealViewSwitcher extends ViewGroup {
    ...
    private OnScrollStartedListener mOnScrollStartedListener;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (xMoved) {
                    if (mTouchState != TOUCH_STATE_SCROLLING && mOnScrollStartedListener != null)
                        mOnScrollStartedListener.onScrollStarted();
            ...
            case MotionEvent.ACTION_UP:
                ...
                return false; // See if we can send the event back to the WebView.
    ...
    public void orientationChanged(Context ctx) {
    ...
    /**
     * Sets the {@link RealViewSwitcher.OnScreenSwitchListener}.
     *
    ...
    /**
     * Sets the {@link com.android.browser.widget.RealViewSwitcher.OnScrollStartedListener}.
     *
     * @param onScrollStartedListener The listener for scroll start and end events.
     */
    public void setOnScrollStartedListener(OnScrollStartedListener onScrollStartedListener) {
        mOnScrollStartedListener = onScrollStartedListener;
    }
}
