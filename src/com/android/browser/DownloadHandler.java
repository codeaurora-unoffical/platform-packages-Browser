...
public class DownloadHandler {
    ...
    public static void initStorageDefaultPath() {
        ...
        Log.e(LOGTAG,"---------EXTERNAL_STORAGE_SUFFIX ---------" + EXTERNAL_STORAGE_SUFFIX);
        if (isPhoneStorageSupported()) {
            INTERNAL_STORAGE_SUFFIX= getPhoneStorageDirectory();
            Log.e(LOGTAG,"---------INTERNAL_STORAGE_SUFFIX ---------" + INTERNAL_STORAGE_SUFFIX);
        } else {
    ...
    public static String getDefaultDownloadPath(Activity activity, String mimetype) {
        String savepath;
        if (isPhoneStorageSupported()) {
            savepath= INTERNAL_STORAGE_SUFFIX + activity.getResources().getText(R.string.default_savepath_name).toString();
        } else {
            savepath = EXTERNAL_STORAGE_SUFFIX + activity.getResources().getText(R.string.default_savepath_name).toString();
        }
        if (mimetype != null && mimetype.startsWith("image")) {
            savepath =savepath + "/Picture/";
    ...
    */
    ...
    public static String getDownloadPathForUser(Activity activity, String downloadPath) {
        ...
        Log.e(LOGTAG,"---------- before downloadPath -----------" + downloadPath);
        if (downloadPath.startsWith(sdCardDir)) {
            Log.e(LOGTAG,"----------  downloadPath -----------" + activity.getResources().getString(R.string.download_path_sd_card_label));
            ...
            Log.e(LOGTAG,"----------  downloadPath -----------" + activity.getResources().getString(R.string.download_path_phone_stroage_label));
        ...
        Log.e(LOGTAG,"---------- after downloadPath -----------" + downloadPath);
        return  downloadPath;       
    }
    /**
    ...
    public static String getDefaultDownloadPath(Context mContext) {
        ...
        Log.e(LOGTAG,"---------defaultStorage ---------" + defaultDownloadPath);
